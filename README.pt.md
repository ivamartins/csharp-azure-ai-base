...
1. Tenha .NET 8+ SDK e Azure Functions Core Tools.
2. `func start` (após restore/build).
3. A função de exemplo processa uma mensagem e enriquece com chamada LLM (mock ou real via API key).
